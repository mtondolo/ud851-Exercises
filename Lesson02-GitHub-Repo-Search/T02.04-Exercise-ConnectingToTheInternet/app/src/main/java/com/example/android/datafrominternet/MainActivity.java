...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        String githubSearchResponseResults = null;
        try {
            githubSearchResponseResults = NetworkUtils.getResponseFromHttpUrl ( githubSearchUrl );
            mUrlDisplayTextView.setText ( githubSearchResponseResults);
        } catch (IOException e){
            e.printStackTrace ();
        }
    }
